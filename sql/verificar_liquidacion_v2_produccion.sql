...
SELECT esperado.tabla, esperado.columna,
  ...
  FROM (
    ...
    UNION ALL SELECT 'pro_liquidacion_detalle', 'valor_vales'
    UNION ALL SELECT 'pro_liquidacion_detalle', 'base_gravable'
    UNION ALL SELECT 'pro_liquidacion_detalle', 'impuesto_pct'
    ...
    UNION ALL SELECT 'pro_sobregiro_transportista', 'monto_sobregiro'
    UNION ALL SELECT 'pro_sobregiro_transportista', 'monto_aplicado'
    UNION ALL SELECT 'pro_sobregiro_transportista', 'saldo_pendiente'
    ...
    UNION ALL SELECT 'pro_abonos_transportista', 'descripcion'
    UNION ALL SELECT 'pro_abonos_transportista', 'fecha_hora_graba'
  ) esperado
